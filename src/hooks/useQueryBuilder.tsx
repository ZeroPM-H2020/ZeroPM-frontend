...
export function buildQueryFromOptions(options: QueryBuilderParams): string {
  const { selectFields, whereConditions } = options;
...
function useQueryBuilder(initialOptions: QueryBuilderParams) {
  ...
  const buildQuery = (): string => {
    return buildQueryFromOptions(queryOptions);
  };
